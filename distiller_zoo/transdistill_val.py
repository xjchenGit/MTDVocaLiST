...
class Loss(nn.Module):
    ...
    def forward(self, anchor):
        ...
        # print(f"a_tea_fus_qk: {a_tea_fus_qk.shape}, a_stu_fus_qk: {a_stu_fus_qk.shape}, self.state: {self.state}")
        ...
        # if self.state is 'att':
        #     # print(f"here is attention !")
        #     loss = self.kl_div(a_stu_fus_qk.log(), a_tea_fus_qk)
        #     # print(f"att: {loss}")
        # #     # return loss
        # # if self.state is 'val':
        # print(f"loss:{loss}")
